...
def process_qtr_mile_data(conn, config):
    ...
    try:
        ...
        SELECT DISTINCT i.it_checksum,
               ...
               oc.pw_series, oc.pw_sea_desc, oc.pw_sea_yr, oc.pw_ep_desc,
               oc.pw_air, oc.pw_nw_rat, oc.pw_genre,
               hs.tvm_id, hs.tvm_series_desc, hs.tvm_sea_yr, hs.tvm_ep_desc,
               hs.tvm_air, hs.tvm_studio, hs.tvm_genre, hs.tvm_nw_rat, hs.tvm_cast,
               h.imdb_id, h.imdb_series_desc, h.imdb_sea_yr, h.imdb_ep_desc,
               h.imdb_air, h.imdb_studio, h.imdb_genre, h.imdb_nw_rat, h.imdb_cast,
               af.tmdb_id, af.tmdb_series_desc, af.tmdb_sea_yr, af.tmdb_ep_desc,
               af.tmdb_air, af.tmdb_studio, af.tmdb_genre, af.tmdb_nw_rat, af.tmdb_cast,
               dc.tvdb_id, dc.tvdb_series_desc, dc.tvdb_sea_yr, dc.tvdb_ep_desc,
...
def process_row(row, config, release_group, user_input):
    ...
    (checksum, it_sea_no, it_ep_no, it_subtitles,
     ...
     pw_series, pw_sea_desc, pw_sea_yr, pw_ep_desc, pw_air, pw_nw_rat, pw_genre,
     tvm_id, tvm_series_desc, tvm_sea_yr, tvm_ep_desc, tvm_air, tvm_studio,
     tvm_genre, tvm_nw_rat, tvm_cast,
     imdb_id, imdb_series_desc, imdb_sea_yr, imdb_ep_desc, imdb_air,
     imdb_studio, imdb_genre, imdb_nw_rat, imdb_cast,
     tmdb_id, tmdb_series_desc, tmdb_sea_yr, tmdb_ep_desc, tmdb_air,
     tmdb_studio, tmdb_genre, tmdb_nw_rat, tmdb_cast,
     tvdb_id, tvdb_series_desc, tvdb_sea_yr, tvdb_ep_desc, tvdb_air,
     tvdb_studio, tvdb_genre) = row
